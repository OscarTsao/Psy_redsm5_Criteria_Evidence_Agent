...
from pairwise_data import make_pairwise_datasets, load_dsm5_criteria
...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='outputs_pairwise')
    ...
    for epoch in range(1, args.num_epochs + 1):
        ...
        if val_overall['f1'] > best_f1:
            ...
            torch.save(ckpt, os.path.join(args.output_dir, 'best_pairwise.pt'))
